...
|---|---|---|---|---|
| Benchmark team (simple / layered) | `random42_simple_layered_team5_v1` (free_0731 interface pool) | frozen 08-14; module `benchmarkTeamSim.js` repro 08-15 | `runs_v4flash_0731/team_pilot/random42_free_0731_interface_team5_simple_teamlayerednomap_deepseek_20260814` (module repro: worktree `team_pilot/benchmark_split_repro42_20260815`) | single round (n=42 each): simple SD 448, mean 4429, loss 19%, cards 10.6; layered SD 500, mean 4540, loss 10%, cards 10.5. Module repro: SD 495 / 509, loss 10% / 7%. **Not yet interval-ized (1×42).** |
| Benchmark individual (simple / layered) | `random42_simple_layered_individual_v1` (same pool) | frozen 08-14 | `runs_v4flash_0731/random42_free_0731_interface_simple_20260814`, `…_layered_20260814` (chains) | single round (n=42 each): simple SD 383, mean 4467, loss 62%; layered SD 373, mean 4474, loss 50%. **Not yet interval-ized (1×42).** |
