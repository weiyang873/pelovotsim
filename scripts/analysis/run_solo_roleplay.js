...
const SUPPORTED_ARMS = new Set(["team_room_r1_screenplay_v1", "team_room_roleplay_ui"]);
...
function parseArgs(argv) {
  ...
  if (!args.arms.length || args.arms.some((arm) => !SUPPORTED_ARMS.has(arm))) {
...
async function main() {
  ...
  const { runTeam } = require("../../server/synthetic/teamSim/soloRoleplaySim");
